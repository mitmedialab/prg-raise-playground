...
const { watch, specifiedDir, ...args } = processOptions();
...
const bundleExtensions = fork(bundleExtensionsScript, convertToArgs({ watch, [flagByOption.specifiedDir]: specifiedDir }));
