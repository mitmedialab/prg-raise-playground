 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ae=function(e){let t=0;for(let n=0;n<e.length;n++){const i=e.charCodeAt(n);i<128?t++:i<2048?t+=2:i>=55296&&i<=56319?(t+=4,n++):t+=3}return t};
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function Re(e){return e&&e._delegate?e._delegate:e}class De{constructor(e,t,n){this.name=e,this.instanceFactory=t,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xt="firebase-heartbeat-database",It=1,Nt="firebase-heartbeat-store";let Pt=null;function At(){return Pt||(Pt=function(e,t,{blocked:n,upgrade:i,blocking:r,terminated:s}={}){const o=indexedDB.open(e,t),a=tt(o);return i&&o.addEventListener("upgradeneeded",(e=>{i(tt(o.result),e.oldVersion,e.newVersion,tt(o.transaction),e)})),n&&o.addEventListener("blocked",(e=>n(e.oldVersion,e.newVersion,e))),a.then((e=>{s&&e.addEventListener("close",(()=>s())),r&&e.addEventListener("versionchange",(e=>r(e.oldVersion,e.newVersion,e)))})).catch((()=>{})),a}(xt,It,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(Nt)}}).catch((e=>{throw vt.create("idb-open",{originalErrorMessage:e.message})}))),Pt}async function Rt(e,t){try{const n=(await At()).transaction(Nt,"readwrite"),i=n.objectStore(Nt);await i.put(t,Dt(e)),await n.done}catch(e){if(e instanceof ue)ht.warn(e.message);else{const t=vt.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});ht.warn(t.message)}}}function Dt(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
const Pn=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,An="ac",Rn="websocket",Dn="long_polling";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ni;Si.EMPTY_NODE=new class{copy(e,t,n,i,r){return this}insert(e,t,n){return new Ei(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}};const Pi=function(e){return"number"==typeof e?"number:"+Cn(e):"string:"+e},Ai=function(e){if(e.isLeafNode()){const t=e.val();Y("string"==typeof t||"number"==typeof t||"object"==typeof t&&ge(t,".sv"),"Priority must be a string or number.")}else Y(e===Ni||e.isEmpty(),"priority of unexpected type.");Y(e===Ni||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Vi=!0;function Gi(e,t=null){if(null===e)return $i.EMPTY_NODE;if("object"==typeof e&&".priority"in e&&(t=e[".priority"]),Y(null===t||"string"==typeof t||"number"==typeof t||"object"==typeof t&&".sv"in t,"Invalid priority type found: "+typeof t),"object"==typeof e&&".value"in e&&null!==e[".value"]&&(e=e[".value"]),"object"!=typeof e||".sv"in e){return new Li(e,Gi(t))}if(e instanceof Array||!Vi){let n=$i.EMPTY_NODE;return wn(e,((t,i)=>{if(ge(e,t)&&"."!==t.substring(0,1)){const e=Gi(i);!e.isLeafNode()&&e.isEmpty()||(n=n.updateImmediateChild(t,e))}})),n.updatePriority(Gi(t))}{const n=[];let i=!1;if(wn(e,((e,t)=>{if("."!==e.substring(0,1)){const r=Gi(t);r.isEmpty()||(i=i||!r.getPriority().isEmpty(),n.push(new vi(e,r)))}})),0===n.length)return $i.EMPTY_NODE;const r=Bi(n,xi,(e=>e.name),Ii);if(i){const e=Bi(n,Fi.getCompare());return new $i(r,Gi(t),new Ui({".priority":e},{".priority":Fi}))}return new $i(r,Gi(t),Ui.Default)}}!function(e){Di=e}(Gi);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dr{constructor(e){this.writeTree_=e}static empty(){return new Dr(new Rr(null))}}function Or(e,t,n){if(li(t))return new Dr(new Rr(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const r=i.path;let s=i.value;const o=ci(r,t);return s=s.updateChild(o,n),new Dr(e.writeTree_.set(r,s))}{const i=new Rr(n),r=e.writeTree_.setTree(t,i);return new Dr(r)}}}function Lr(e,t,n){let i=e;return wn(n,((e,n)=>{i=Or(i,ai(t,e),n)})),i}function Fr(e,t){if(li(t))return Dr.empty();{const n=e.writeTree_.setTree(t,new Rr(null));return new Dr(n)}}function Mr(e,t){return null!=jr(e,t)}function jr(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(ci(n.path,t)):null}function Br(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Fi,((e,n)=>{t.push(new vi(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new vi(e,n.value))})),t}function qr(e,t){if(li(t))return e;{const n=jr(e,t);return new Dr(null!=n?new Rr(n):e.writeTree_.subtree(t))}}function zr(e){return e.writeTree_.isEmpty()}function Ur(e,t){return Wr(ei(),e.writeTree_,t)}function Wr(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let i=null;return t.children.inorderTraversal(((t,r)=>{".priority"===t?(Y(null!==r.value,"Priority writes must always be leaf nodes"),i=r.value):n=Wr(ai(e,t),r,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(ai(e,".priority"),i)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ds=1;class Os{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Rr(null),this.pendingWriteTree_={visibleWrites:Dr.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Ls(e,t,n,i,r){return function(e,t,n,i,r){Y(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=Or(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?$s(e,new wr({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Fs(e,t,n,i){!function(e,t,n,i){Y(i>e.lastWriteId,"Stacking an older merge on top of newer ones"),e.allWrites.push({path:t,children:n,writeId:i,visible:!0}),e.visibleWrites=Lr(e.visibleWrites,t,n),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i);const r=Rr.fromObject(n);return $s(e,new Cr({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,r))}function Ms(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(Hr(e.pendingWriteTree_,t)){let t=new Rr(null);return null!=i.snap?t=t.set(ei(),!0):wn(i.children,(e=>{t=t.set(new Zn(e),!0)})),$s(e,new vr(i.path,t,n))}return[]}function js(e,t,n){return $s(e,new wr({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Bs(e,t,n,i,r=!1){const s=t._path,o=e.syncPointTree_.get(s);let a=[];if(o&&("default"===t._queryIdentifier||Ps(o,t))){const l=Ss(o,t,n,i);0===o.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(s));const c=l.removed;if(a=l.events,!r){const n=-1!==c.findIndex((e=>e._queryParams.loadsAllData())),r=e.syncPointTree_.findOnPath(s,((e,t)=>As(t)));if(n&&!r){const t=e.syncPointTree_.subtree(s);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&As(t)){return[Rs(t)]}{let e=[];return t&&(e=xs(t)),wn(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const i=n[t],r=i.query,s=Gs(e,i);e.listenProvider_.startListening(Zs(r),Js(e,r),s.hashFn,s.onComplete)}}}if(!r&&c.length>0&&!i)if(n){const n=null;e.listenProvider_.stopListening(Zs(t),n)}else c.forEach((t=>{const n=e.queryToTagMap.get(Qs(t));e.listenProvider_.stopListening(Zs(t),n)}))}!function(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const t=Qs(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,c)}return a}function qs(e,t,n,i){const r=Ys(e,i);if(null!=r){const i=Ks(r),s=i.path,o=i.queryId,a=ci(s,t);return Xs(e,s,new wr(yr(o),a,n))}return[]}function zs(e,t,n,i=!1){const r=t._path;let s=null,o=!1;e.syncPointTree_.foreachOnPath(r,((e,t)=>{const n=ci(e,r);s=s||Is(t,n),o=o||As(t)}));let a,l=e.syncPointTree_.get(r);if(l?(o=o||As(l),s=s||Is(l,ei())):(l=new Cs,e.syncPointTree_=e.syncPointTree_.set(r,l)),null!=s)a=!0;else{a=!1,s=$i.EMPTY_NODE;e.syncPointTree_.subtree(r).foreachChild(((e,t)=>{const n=Is(t,ei());n&&(s=s.updateImmediateChild(e,n))}))}const c=Ps(l,t);if(!c&&!t._queryParams.loadsAllData()){const n=Qs(t);Y(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const i=Ds++;e.queryToTagMap.set(n,i),e.tagToQueryMap.set(i,n)}let h=Es(l,t,n,$r(e.pendingWriteTree_,r),s,a);if(!c&&!o&&!i){const n=Ns(l,t);h=h.concat(function(e,t,n){const i=t._path,r=Js(e,t),s=Gs(e,n),o=e.listenProvider_.startListening(Zs(t),r,s.hashFn,s.onComplete),a=e.syncPointTree_.subtree(i);if(r)Y(!As(a.value),"If we're adding a query, it shouldn't be shadowed");else{const t=a.fold(((e,t,n)=>{if(!li(e)&&t&&As(t))return[Rs(t).query];{let e=[];return t&&(e=e.concat(xs(t).map((e=>e.query)))),wn(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const i=t[n];e.listenProvider_.stopListening(Zs(i),Js(e,i))}}return o}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(i.mockUserToken,e.app.options.projectId);s=new Nn(t)}!function(e,t,n,i){e.repoInfo_=new On(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams,!0),i&&(e.authTokenProvider_=i)}(r,t,n,s)}function hl(e){var t;(e=Re(e))._checkNotDeleted("goOnline"),(t=e._repo).persistentConnection_&&t.persistentConnection_.resume(zo)}function ul(e,t){an(e,t)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cl{constructor(e,t){this._delegate=e,this.app=t,this.INTERNAL={delete:()=>this._delegate._delete(),forceWebSockets:al,forceLongPolling:ll}}useEmulator(e,t,n={}){cl(this._delegate,e,t,n)}ref(e){if(xe("database.ref",0,1,arguments.length),e instanceof wl){const t=Ia(this._delegate,e.toString());return new wl(this,t)}{const t=xa(this._delegate,e);return new wl(this,t)}}refFromURL(e){xe("database.refFromURL",1,1,arguments.length);const t=Ia(this._delegate,e);return new wl(this,t)}goOffline(){return xe("database.goOffline",0,0,arguments.length),(e=Re(e=this._delegate))._checkNotDeleted("goOffline"),void ta(e._repo);var e}goOnline(){return xe("database.goOnline",0,0,arguments.length),hl(this._delegate)}}Cl.ServerValue={TIMESTAMP:dl,increment:e=>function(e){return{".sv":{increment:e}}}(e)};var kl=Object.freeze({__proto__:null,initStandalone:
/**
 * @license
 * Copyright 2017 Google LLC
 *
