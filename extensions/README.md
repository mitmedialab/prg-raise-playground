...
![Gif of extension addOns being suggested](/docs/assets/addOns.gif)
...
sequenceDiagram
    ...
    C-->>B: Lerna utility forces scratch-gui <br>to use /scratch-packages/scratch-vmvm for its dependency <br>instead of using the external npm package
