 ...
 * @enum {int}
 */
export declare const enum ScratchBlocksConstants {
    /**
...
export declare const enum StageLayering {
    BackgroundLayer = "background",
    VideoLayer = "video",
    PenLayer = "pen",
    SpriteLayer = "sprite"
}
export declare const LayerGroups: UnionToTuple<StageLayering>;
...
export declare const enum Branch {
    Exit = 0,
    Enter = 1,
    First = 1,
    Second = 2,
...
export declare const enum RuntimeEvent {
    /**
