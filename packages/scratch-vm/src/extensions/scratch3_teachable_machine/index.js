...
class Scratch3VideoSensingBlocks {
            ...
            blocks: [
                {
                    ...
                    arguments: {
                        MODEL_URL: {
                            ...
                            defaultValue:
                                this.teachableImageModel ||
                                "https://teachablemachine.withgoogle.com/models/-2wS02uZo/",
                        },
                    },
                },
                "---",
    ...
    async getPredictionFor(args, util) {
        ...
        if (image_source == "camera") {
            ...
            const drawable =
                this.runtime.renderer._allDrawables[util.target.drawableID];
