...
var Extension_1 = require("../../typescript-support/Extension");
var roslib_1 = __importDefault(require("roslib"));
var EXTENSION_ID = "jibo";
var _colors = {
    "red": { x: 255, y: 0, z: 0 },
...
var Scratch3Jibo = /** @class */ (function (_super) {
    ...
    ;
    Scratch3Jibo.prototype.defineBlocks = function () {
        var _this = this;
        return {
            JiboTTS: function (self) { return ({
            ...
            JiboAsk: function (self) { return ({
                ...
                text: function (text) { return "ask ".concat(text, " and wait"); },
                operation: function (text) { return _this.JiboAsk(text); }
            }); },
            JiboListen: function (self) { return ({
            ...
            JiboLook: function (self) { return ({
                ...
                text: function (x_angle, y_angle, z_angle) { return "set Jibo Look at ".concat(x_angle, ", ").concat(y_angle, ", ").concat(z_angle); },
    ...
    Scratch3Jibo.prototype.connect = function () {
        console.log("this.connect");
    };
    Scratch3Jibo.prototype.disconnect = function () { };
    Scratch3Jibo.prototype.scan = function () { };
    Scratch3Jibo.prototype.isConnected = function () {
        console.log("isConnected status: " + this.connected);
        return this.connected;
    };
    Scratch3Jibo.prototype.updateProgress = function () {
        this.calculatePercentage();
    };
    Scratch3Jibo.prototype.progressReport = function (progressState) {
    ...
    Scratch3Jibo.prototype.updateTutorial = function (tutorial, step) {
    ...
    Scratch3Jibo.prototype.calculatePercentage = function () {
        if (!this.runtime || !this.runtime.modelData || this.runtime.targets <= 0) {
            return;
        }
        var modelData = this.runtime.modelData.classifierData;
        var blocks_used = this.runtime.targets[1].blocks._blocks;
    ...
    Scratch3Jibo.prototype.numberOfClasses = function (textModel) {
        var textModelClasses = Object.keys(textModel);
    ...
    Scratch3Jibo.prototype.atLeastFive = function (textModel) {
        var minimum = false;
        for (var label in textModel) {
    ...
    Scratch3Jibo.prototype.balancedClasses = function (keys) {
        var classNumbers = [];
        var minimum = false;
        for (var label in keys) {
            var count = 0;
            for (var _ in keys[label]) {
                count = count + 1;
            }
    ...
    Scratch3Jibo.prototype.analyzeBlocks = function (blocks) {
        var count = 0;
        var parents = [];
        var sensing = 0;
        var answer = 0;
        var usedEmbeddedConditionals = false;
    ...
    Scratch3Jibo.prototype.RosConnect = function (args) {
        var rosIP = cast_1.default.toString(args.rosIP);
        this.rosbridgeIP = "ws://" + rosIP + ":9090";
        log_1.default.log("ROS: Attempting to connect to rosbridge at " + this.rosbridgeIP);
        if (!this.connected) {
            this.ros = new roslib_1.default.Ros({
                url: this.rosbridgeIP
            });
            // If connection is successful
            var connect_cb_factory = function (x) {
                return function () {
                    x.connected = true;
            ...
            var connect_cb_1 = connect_cb_factory(this);
            this.ros.on('connection', function () {
                connect_cb_1();
                log_1.default.info('ROS: Connected to websocket server.');
            });
            // If connection fails
            var error_cb_factory = function (x) { return function () { x.failed = true; }; };
            var error_cb_1 = error_cb_factory(this);
            this.ros.on('error', function (error) {
                error_cb_1();
                log_1.default.error('ROS: Error connecting to websocket server: ', error);
            });
            // If connection ends
            var disconnect_cb_factory = function (x) { return function () { x.connected = false; }; };
            var disconnect_cb_1 = disconnect_cb_factory(this);
            this.ros.on('close', function () {
                disconnect_cb_1();
                log_1.default.info('ROS: Connection to websocket server closed.');
            });
        }
        this.JiboState();
        this.JiboPublish({
    ...
    Scratch3Jibo.prototype.JiboAsk = function (text) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.JiboASR_reseive()];
                    case 2:
                        // wait for sensor to return
                        _a.asr_out = _b.sent();
                        return [2 /*return*/];
    ...
    Scratch3Jibo.prototype.JiboListen = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.asr_out];
            });
        });
    };
    Scratch3Jibo.prototype.JiboLED = function (color) {
        var ledHex = _colors[color];
        if (ledHex == "random") {
            var randomColorIdx = Math.floor(Math.random() * (Object.keys(_colors).length - 1));
            var randomColor = Object.keys(_colors)[randomColorIdx];
    ...
    Scratch3Jibo.prototype.JiboLEDOff = function () {
        return __awaiter(this, void 0, void 0, function () {
            var jibo_msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Scratch3Jibo.prototype.JiboEmoji = function (akey) {
        return __awaiter(this, void 0, void 0, function () {
            var animation_key;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // }
    Scratch3Jibo.prototype.JiboAnim = function (animation_key) {
        return __awaiter(this, void 0, void 0, function () {
            var jibo_msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        log_1.default.log(animation_key);
                        jibo_msg = {
                            "do_motion": true,
                            "do_tts": false,
                            "do_lookat": false,
    ...
    // }
    Scratch3Jibo.prototype.JiboMultitask = function () {
        return __awaiter(this, void 0, void 0, function () {
            var jibo_msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        jibo_msg = {
                            ...
                            "do_motion": true,
                            "motion": "Emoji/Emoji_HeartArrow_01_01.keys",
                            // "do_tts": true, 
    ...
    Scratch3Jibo.prototype.JiboPublish = function (msg) {
        return __awaiter(this, void 0, void 0, function () {
            var cmdVel, jibo_msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        cmdVel = new roslib_1.default.Topic({
                            ros: this.ros,
                            name: '/jibo',
    ...
    Scratch3Jibo.prototype.JiboASR_request = function () {
        if (!this.connected) {
            console.log("ROS is not connetced");
            return false;
        }
        ...
        var jibo_msg = new roslib_1.default.Message({ "heyjibo": false, "command": 1 });
        cmdVel.publish(jibo_msg);
    };
    Scratch3Jibo.prototype.JiboASR_reseive = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                        var asr_listener = new roslib_1.default.Topic({
                            ros: _this.ros,
    ...
    Scratch3Jibo.prototype.hexToRgb = function (hex) {
