    ...
    getInfo () {
        return {
            ...
            name: formatMessage({
                ...
                description: 'Extension using ESPCam Chrome extension to communicate with Microbit robot'
            }),
    ...
    connectToExtension() {
        ...
        chrome.runtime.sendMessage(this.CHROME_EXTENSION_ID, { launch: true }, function (response) {
            if (response === undefined) { //Chrome app not found
                ...
                robot.CHROME_EXTENSION_ID = window.localStorage.getItem('espcam_extension_id');
                ...
                window.localStorage.setItem('espcam_extension_id', robot.CHROME_EXTENSION_ID);
                if (robot._mStatus !== 2) {
