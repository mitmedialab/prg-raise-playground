...
class MicrobitRobot {
    ...
    getInfo() {
        return {
            ...
            name: formatMessage({
                ...
                description:
                    "Extension using ESP32 cam webserver to communicate with Microbit robot",
            }),
            ...
            blocks: [
                {
                    ...
                    text: formatMessage({
                        ...
                        description:
                            "Set the IP address for this robot and open a websocket connection",
                    }),
                    arguments: {
                        IP_ADDRESS: {
    ...
    async requestFromRobot() {
        ...
        this._mConnectionTimeout = setTimeout(
            this.requestFromRobot.bind(this),
            100
        );
        return true;
    }
