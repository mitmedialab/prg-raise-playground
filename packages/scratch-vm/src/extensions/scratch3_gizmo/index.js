        ...
        chrome.runtime.sendMessage(
            ...
            function (response) {
                if (response === undefined) {
                    ...
                    robot.CHROME_EXTENSION_ID =
                        window.localStorage.getItem("gizmo_extension_id");
                    console.log(
                    ...
                    if (
                        ...
                        robot.CHROME_EXTENSION_ID = window.prompt(
                            ...
                            "pnjoidacmeigcdbikhgjolnadkdiegca"
                        );
                    }
                    robot._mStatus = 0;
