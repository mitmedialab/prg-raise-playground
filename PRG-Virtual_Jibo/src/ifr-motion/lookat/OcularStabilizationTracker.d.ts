 ...
 * @constructor
 */
declare function OcularStabilizationTracker(lookatNode: LookatNode, dofAligner: DOFGlobalAlignment): void;
declare class OcularStabilizationTracker {
    constructor(lookatNode: LookatNode, dofAligner: DOFGlobalAlignment);
    /**
     *
